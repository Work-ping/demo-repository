...
import AddProject from './AddProjectsForm';
      ...
      <Row>
            ...
            <CardBody>
              <div className="d-flex flex-wrap justify-content-between gap-3">
                <div className="search-bar">
                  ...
                  <input type="search" className="form-control" id="search" placeholder="Search Project..." />
                </div>
                <div>
                 <Button variant="primary" className="d-inline-flex align-items-center" onClick={handleOpen}>
              ...
              <div className="table-responsive table-centered">
                <table className="table text-nowrap mb-0">
                  <thead className="bg-light bg-opacity-50">
                    <tr>
                      <th className="border-0 py-2">Project Title</th>
       ...
       <Offcanvas
                ...
                <Offcanvas.Body className="overflow-auto">
                    <AddProject onCancel={handleClose} />
                </Offcanvas.Body>
        </Offcanvas>
        </Col>
      </Row>
